...
5.4 Регулярные выражения
  ...
  1) Задание 5.4.16 [Директория](Tasks/5.4/Task_16/src/org/example) (PLAN: 0.3 FACT: 0.4)

     **Условие:** Добавьте в HKA многочастные операции или.

  2) Задание 5.4.17 [Директория](Tasks/5.4/Task_17/src/org/example) (PLAN: 0.4 FACT: 0.5)

     **Условие:** Добавьте в класс NFA обработку обобщённых символов.

  3) Задание 5.4.18 [Директория](Tasks/5.4/Task_18/src/org/example) (PLAN: 0.4 FACT: 0.3)

     **Условие:** Добавьте в класс NFA обработку опреации замыкания +.

  4) Задание 5.4.20 [Директория](Tasks/5.4/Task_20/src/org/example) (PLAN: 0.4 FACT: 0.3)

     **Условие:** Добавьте в класс NFA обработку описателей диапазонов.
